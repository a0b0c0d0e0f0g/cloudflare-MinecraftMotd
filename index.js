...
async function handleImageRequest(serverIP) {
  ...
  try {
    ...
    const icon = (isOnline && data.icon) ? data.icon : "data:image/png;base64,";
...
<head>
    ...
    <style>
        body { background: #11111b; color: #cdd6f4; font-family: system-ui; display: flex; flex-direction: column; align-items: center; padding: 20px; min-height: 100vh; justify-content: center; margin: 0; }
        .box { background: #1e1e2e; padding: 30px; border-radius: 24px; width: 100%; max-width: 440px; text-align: center; box-shadow: 0 20px 50px rgba(0,0,0,0.5); border: 1px solid #313244; }
        .logo { width: 64px; height: 64px; margin-bottom: 15px; border-radius: 12px; }
        input { width: 100%; padding: 14px; margin: 20px 0; border-radius: 12px; border: 1px solid #45475a; background: #181825; color: white; box-sizing: border-box; font-size: 16px; outline: none; transition: 0.3s; }
        input:focus { border-color: #89b4fa; box-shadow: 0 0 0 2px rgba(137, 180, 250, 0.2); }
        button { background: #89b4fa; color: #11111b; border: none; padding: 14px 30px; border-radius: 12px; font-weight: bold; cursor: pointer; width: 100%; font-size: 16px; transition: 0.2s; }
        button:hover { background: #b4befe; transform: translateY(-2px); }
        #res { margin-top: 30px; width: 100%; }
        img { width: 100%; border-radius: 16px; box-shadow: 0 10px 20px rgba(0,0,0,0.3); }
...
<body>
    <div class="box">
        ...
        <h2 style="margin:0; color:#ffffff;">Minecraft Motd 获取</h2>
        <p style="color:#a6adc8; font-size:14px;">输入服务器地址，生成精美状态卡片</p>
        <input type="text" id="ip" placeholder="例如: play.hypixel.net" spellcheck="false">
        <button onclick="gen()">生成卡片</button>
        <div id="res"></div>
        <div class="footer">Powered by Cloudflare Workers & mcstatus.io</div>
    </div>
    <script>
        function gen() {
            ...
            document.getElementById('res').innerHTML = '<img src="' + url + '">';
        }
    </script>
</body>
</html>
